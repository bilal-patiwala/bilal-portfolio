        ...
        <div className='projects'>
            ...
            <div className='project-list'>
                {data.map((project, index) => (
                    <div key={index} class="max-w- p-6 bg-white border border-gray-200 rounded-lg shadow bg-[#1a2639] dark:border-gray-700">
                        <p>
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{project.title}</h5>
                        </p>
                        <ul className='point-list'>
                            <li class="mb-3 font-normal text-[#ececec] dark:text-gray-400">{project.description}</li>
                            <li class="mb-3 font-normal text-[#ececec] dark:text-gray-400">{project['tech-stack']}</li>
                        </ul>
